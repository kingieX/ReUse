...
import { Users, Recycle, Gift, TrendingUp, CheckCircle, Clock } from "lucide-react";
...
export function AdminDashboard() {
  ...
  const recentUsers = [
    { id: "1", name: "John Doe", phone: "+234 801 234 5678", joinDate: "Nov 12, 2025", tokens: 120 },
    { id: "2", name: "Jane Smith", phone: "+234 802 345 6789", joinDate: "Nov 11, 2025", tokens: 85 },
    { id: "3", name: "Michael Johnson", phone: "+234 803 456 7890", joinDate: "Nov 10, 2025", tokens: 150 },
    { id: "4", name: "Sarah Williams", phone: "+234 804 567 8901", joinDate: "Nov 9, 2025", tokens: 95 },
    { id: "5", name: "David Brown", phone: "+234 805 678 9012", joinDate: "Nov 8, 2025", tokens: 110 }
  ];

  const recentRedemptions = [
    { id: "1", user: "John Doe", reward: "₦200 Airtime", tokens: 75, date: "Nov 12, 2025", status: "completed" },
    { id: "2", user: "Jane Smith", reward: "1GB Data", tokens: 90, date: "Nov 11, 2025", status: "completed" },
    { id: "3", user: "Michael Johnson", reward: "₦500 Cash", tokens: 200, date: "Nov 10, 2025", status: "pending" },
    { id: "4", user: "Sarah Williams", reward: "₦100 Airtime", tokens: 40, date: "Nov 9, 2025", status: "completed" }
  ];
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Review and confirm user drop-offs</CardDescription>
              </div>
          ...
          <CardContent>
                ...
                <TableBody>
                  {pendingDropoffs.map((dropoff) => (
                    <TableRow key={dropoff.id}>
                      ...
                      <TableCell className="text-[#FACC15]">{dropoff.tokens} tokens</TableCell>
                      <TableCell className="text-[#64748B]">{dropoff.date}</TableCell>
                      <TableCell>
                        {dropoff.photo ? (
            ...
            {pendingDropoffs.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-[#64748B]">All drop-offs have been processed!</p>
              </div>
            )}
          </CardContent>
        </Card>
                    ...
                    <TableBody>
                      {recentUsers.map((user) => (
                        <TableRow key={user.id}>
                          ...
                          <TableCell className="text-[#FACC15]">{user.tokens} tokens</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
                    ...
                    <TableBody>
                      {recentRedemptions.map((redemption) => (
                        <TableRow key={redemption.id}>
                          ...
                          <TableCell className="text-[#FACC15]">{redemption.tokens} tokens</TableCell>
                          <TableCell className="text-[#64748B]">{redemption.date}</TableCell>
                          <TableCell>
