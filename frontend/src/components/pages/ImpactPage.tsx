  ...
  const milestones = [
    {
      ...
      description: "Completed your first recycling",
      achieved: true,
    },
    {
      title: "Eco Warrior",
      description: "Recycled 10kg of materials",
      achieved: true,
    },
    {
      title: "Community Leader",
      description: "50 drop-offs completed",
      achieved: false,
    },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-[#64748B] max-w-3xl mx-auto">
            Every recyclable you drop off contributes to a cleaner Nigeria and a
            healthier planet. Together, we're transforming waste into value and
            ...
            {impactStats.map((stat, index) => (
              <Card key={index} className="border-0 shadow-md overflow-hidden">
                ...
                <CardContent className="p-6 text-center">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${stat.color} flex items-center justify-center text-white`}
                  >
                    {stat.icon}
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center text-white">
                  ...
                  <p className="text-[#64748B] mb-4">
                    Recyclables are collected at verified drop-off points across
                    Delta State
                  </p>
                </div>
                <div className="text-center text-white">
                  ...
                  <p className="text-white/90">
                    Materials are sorted and processed by certified recycling
                    partners
                  </p>
                </div>
                <div className="text-center text-white">
                  ...
                  <p className="text-white/90">
                    Recycled materials reduce pollution and conserve natural
                    resources
                  </p>
                </div>
              </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {milestones.map((milestone, index) => (
              <Card
                key={index}
                className={milestone.achieved ? "border-[#22C55E]" : ""}
              >
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-[#64748B]">
                  Total plastic diverted from landfills
                </p>
              </CardContent>
            </Card>
            <Card>
        ...
        <Card className="bg-gradient-to-br from-[#14532D] to-[#166534] border-0 shadow-xl">
          <CardContent className="p-8 md:p-12 text-center">
            ...
            <p className="text-white/90 mb-8 max-w-2xl mx-auto">
              Join our network of recycling partners and help us expand our
