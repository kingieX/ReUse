...
import { Building2, Handshake, TrendingUp, Shield, CheckCircle } from "lucide-react";
...
export function PartnersPage() {
  const partnerTypes = [
    {
      ...
      description: "Join our network of verified drop-off points and reach more customers",
      benefits: ["Increased foot traffic", "Digital presence", "Quality assurance badge"]
    },
    {
    ...
    },
    {
      ...
      benefits: ["New customer acquisition", "Brand exposure", "Performance tracking"]
    }
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success("Partnership inquiry submitted! We'll contact you within 48 hours.");
  };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-[#64748B] max-w-3xl mx-auto">
            Join Nigeria's leading smart recycling platform and help us build a sustainable future 
        ...
        <Card className="border-0 shadow-xl max-w-3xl mx-auto">
          <CardContent className="p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-[#64748B]">Fill out the form below and we'll get back to you within 48 hours</p>
            </div>
